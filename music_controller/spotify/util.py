...
from music_controller.settings import SPOTIFY_REDIRECT_URI, SPOTIFY_CLIENT_ID, SPOTIFY_CLIENT_SECRET
...
def update_or_create_user_token(session_id, access_token, token_type, expires_in, refresh_token):
    ...
    if tokens:
        ...
        tokens.save(update_fields=['access_token', 'refresh_token', 'expire_in', 'token_type'])
    else:
